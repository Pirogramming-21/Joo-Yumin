...
function contrast_numbers(inputNumber1, inputNumber2, inputNumber3) {
    ...
    for (let i = 0; i < randomNumbers.length; i++) {
        if (randomNumbers[i] === inputNumber1 && i === 0 ||
            ...
            strikeNumbers++;
        } else if (randomNumbers.includes(inputNumber1) ||
                   randomNumbers.includes(inputNumber2) ||
                   randomNumbers.includes(inputNumber3)) {
            ballNumbers++;
        }
    }
    return `
